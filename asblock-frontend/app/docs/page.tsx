    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <SiteMain>
        <SitePageContainer variant="document" padding="document">
          <h1 className="text-3xl sm:text-4xl font-semibold text-balance mb-4">Documentation</h1>
          ...
          <section className="space-y-4" id="api">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <span className="font-mono text-foreground/90">/swagger</span> on your API host (e.g.{' '}
              <span className="font-mono text-foreground/90">https://localhost:7000/swagger</span>
              ).
            </p>
          </section>
        </SitePageContainer>
