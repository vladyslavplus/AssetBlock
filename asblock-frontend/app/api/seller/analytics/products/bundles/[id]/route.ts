...
/** Proxies GET /api/seller/analytics/products/bundles/{id} with session cookies. */
export async function GET(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const backendPath = `/api/seller/analytics/products/bundles/${encodeURIComponent(parsedId.value)}${query.qs}`
