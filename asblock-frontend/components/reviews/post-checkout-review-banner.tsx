    ...
    <>
      ...
      >
        <div className="flex gap-2">
          ...
          <div className="min-w-0 space-y-1">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              <span className="font-medium text-foreground break-words">{title}</span>. You can also do this later from{" "}
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:items-center">
          ...
          <Button type="button" size="sm" variant="outline" className="border-border" onClick={handleDismiss}>
            Maybe later
          </Button>
        </div>
      </div>
