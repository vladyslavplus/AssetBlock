...
export const FEATURED_ASSETS_MOCK: AssetListItem[] = [
  {
    ...
    description:
      'Production-ready admin dashboard with auth, charts, and data tables. Fully typed with TypeScript.',
    price: 49,
    categoryId: 'cat-001',
  ...
  },
  {
    ...
    description:
      'Full-stack SaaS template with billing, team management, and feature flags pre-wired.',
    price: 99,
    categoryId: 'cat-002',
  ...
  },
  {
    ...
    description:
      'Node.js CLI for generating project structures with customizable templates and prompts.',
    price: 19,
    categoryId: 'cat-003',
  ...
  },
  {
    ...
    description:
      '60+ accessible, dark-mode-ready components built with Tailwind CSS and Radix primitives.',
    price: 79,
    categoryId: 'cat-001',
    categoryName: 'Templates',
    authorId: 'usr-005',
  ...
  },
  {
    ...
    description:
      'Battle-tested CI/CD workflow templates for Node.js, Docker, and multi-cloud deployments.',
    price: 29,
    categoryId: 'cat-005',
    categoryName: 'DevOps',
    authorId: 'usr-006',
