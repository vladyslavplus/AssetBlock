...
**High-level capabilities:** marketing home with featured catalog strip, asset catalog with filters and pagination, asset detail and checkout flow, authenticated library and account settings (including email verification UX gates for marketplace actions), seller hub (listings, upload, edit), admin UI for categories/tags/review moderation and audit log browse, lightweight docs page, login and registration.
