...
namespace AssetBlock.Infrastructure.Migrations
{
    ...
    [Migration("20260905104829_AddPgvectorAssetEmbeddingStorage")]
    partial class AddPgvectorAssetEmbeddingStorage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetBlock.Domain.Core.Entities.Category", b =>
                {
                    ...
                    b.HasIndex(new[] { "Slug" }, "IX_categories_Slug_trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex(new[] { "Slug" }, "IX_categories_Slug_trgm"), "GIN");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex(new[] { "Slug" }, "IX_categories_Slug_trgm"), new[] { "gin_trgm_ops" });
            ...
            modelBuilder.Entity("AssetBlock.Domain.Core.Entities.OutboxEmailDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("outbox_email_deliveries", (string)null);
                });
            ...
            modelBuilder.Entity("AssetBlock.Domain.Core.Entities.OutboxMessage", b =>
                {
                    ...
                    b.HasIndex("Status", "DeadLetteredAt", "OccurredAt")
                        .HasDatabaseName("IX_outbox_messages_dead_letter");

                    b.HasIndex("Status", "NextAttemptAt", "LockedUntil", "OccurredAt")
            ...
            modelBuilder.Entity("AssetBlock.Domain.Core.Entities.ProcessedStripeWebhookEvent", b =>
                {
                    ...
                    b.ToTable("processed_stripe_webhook_events", (string)null);
                });
