...
public static class ErrorCodesToErrorMessages
{
    private static readonly IReadOnlyDictionary<string, string> _map = new Dictionary<string, string>
    {
        ...
        { ErrorCodes.ERR_CATEGORY_IN_USE, "The category cannot be deleted because it is in use by one or more assets." },
        ...
        { ErrorCodes.ERR_AI_DISABLED, "AI generation is disabled." },
        { ErrorCodes.ERR_AI_PROVIDER_UNAVAILABLE, "The AI provider is temporarily unavailable." },
        { ErrorCodes.ERR_AI_RATE_LIMITED, "The AI provider rate limit was reached. Try again later." },
        { ErrorCodes.ERR_AI_TIMEOUT, "The AI provider timed out." },
        { ErrorCodes.ERR_AI_UNAUTHORIZED, "The AI provider rejected the credentials." },
        { ErrorCodes.ERR_AI_PAYMENT_REQUIRED, "The AI provider requires billing or quota." },
        { ErrorCodes.ERR_AI_FORBIDDEN, "The AI provider denied the request." },
        { ErrorCodes.ERR_AI_INVALID_REQUEST, "The AI request was rejected." },
        { ErrorCodes.ERR_AI_INVALID_RESPONSE, "The AI provider returned an invalid response." },
        { ErrorCodes.ERR_AI_MODEL_NOT_ALLOWED, "The configured AI model is not approved by policy." },
        { ErrorCodes.ERR_AI_CATEGORY_NOT_ALLOWED, "The suggested category is not in the allowed list." },
        { ErrorCodes.ERR_AI_TAGS_NOT_ALLOWED, "One or more suggested tags are not in the allowed list." },
        { ErrorCodes.ERR_AI_INPUT_TOO_LARGE, "The listing context exceeds the AI input limit." },
