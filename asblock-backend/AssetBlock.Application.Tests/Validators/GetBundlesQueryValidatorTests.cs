...
public sealed class GetBundlesQueryValidatorTests
{
    ...
    {
        ValidationResult result = await _validator.ValidateAsync(Valid(minPrice: 50m, maxPrice: 10m));
    ...
    {
        ValidationResult result = await _validator.ValidateAsync(Valid(minPrice: 10m, maxPrice: 10m));
    ...
    {
        ValidationResult result = await _validator.ValidateAsync(Valid(minPrice: 5m, maxPrice: 100m));
    ...
    {
        ValidationResult result = await _validator.ValidateAsync(Valid(minPrice: 5m));
    ...
    {
        ValidationResult result = await _validator.ValidateAsync(Valid(maxPrice: 100m));
    ...
    {
        ValidationResult result = await _validator.ValidateAsync(Valid());
    ...
    {
        ValidationResult result = await _validator.ValidateAsync(Valid(minPrice: (decimal)minPrice));
